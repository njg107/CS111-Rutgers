...
public class WeatherGenerator {
    ...
    int month, double[][] drywet, double[][] wetwet) {
        ...
        int value = month;
        int n = 0;
        if ((value == 2) || (value == 4) || (value == 6) || (value == 8) || (value == 9) || (value == 11) || (value == 13)){
            n = 30;
        } 
        else if (value == 3){
            n = 27;
        ...
        int[] weatherarray= new int[n];
        double x = StdRandom.uniform();
        if (x<=0.49){
            weatherarray[cnt] = WET;
        }
        else {
            weatherarray[cnt] = DRY;
        }
        for (int i=0; i<n; i++){
            if (weatherarray[0]==1){
                double y = StdRandom.uniform();
                if (y<= wetwet[prob1][value]){
                    weatherarray[cnt] = WET;
                }
                else{
                    weatherarray[cnt] = DRY;
